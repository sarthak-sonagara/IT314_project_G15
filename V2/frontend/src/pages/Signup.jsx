                            ...
                            <div className="row">
                                ...
                                <div className="mb-4">
                                  ...
                                  <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" name="inlineRadioOptions" id="AttendeeRole"
                                      value="attendee" required onChange={(e)=>setRole(e.target.value)} />
                                    <label className="form-check-label" htmlFor="femaleGender">Attendee</label>
                                  </div>
                
                                  <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" name="inlineRadioOptions" id="PublisherRole"
                                      value="admin" required onChange={(e)=>setRole(e.target.value)}/>
                                    <label className="form-check-label" htmlFor="maleGender">Admin</label>
                                  </div>
                              ...
                              <div className="row">
                                ...
                                <div className="col-md-6 mb-4 pb-2">
                                  ...
                                  <div className="form-floating">
                                    <input type="password" id="password" className="form-control form-control-lg" placeholder="Password" onChange={(e) => setPassword(e.target.value)} value={password} required/>
                                ...
                                <div className="col-md-6 mb-4 pb-2">
                                  ...
                                  <div className="form-floating">
                                    ...
                                    <label className="form-label" htmlFor="confpassword">Verify Password</label>
                                  </div>
                              ...
                              <div className="mt-1">
                                <input className="btn btn-primary btn-lg" type="submit" value="Sign Up" disabled={isLoading} />
